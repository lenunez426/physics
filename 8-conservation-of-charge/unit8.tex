...
\title{Unit 8: Conservation of Charge}
...
\begin{minipage}{0.35\textwidth}
    \centering
    \fbox{
    \includegraphics[width=5cm]{Figure18.4.jpg}
    }
\end{minipage}
...
\begin{center}
    \includegraphics[width=14cm]{Figures/Figure18.2.jpg}
\end{center}
...
\centering
    \includegraphics[width=6cm]{Figure18.3.jpg}
\end{minipage}
...
% The electrostatic force, as shown in the previous examples, is known as an ``inverse-square law,'' since force scales as 1 over the distance squared:
...
% \framebox{\textbf{Practice}} By what factor does the gravitational force $F$ change if the distance $r$ is changes to 10\% of $r$? 

% \textit{Answer}: $F^{\prime} = 100 F$

% \framebox{\textbf{Practice}} By what factor does the gravitational force between two objects change when the distance between them \textit{increases} by a factor of 4?

% \textit{Answer}: $F^{\prime} = \frac{1}{16} F$

% \framebox{\textbf{Practice}} By what factor does the gravitational force between two objects change when the distance between them \textit{decreases} by a factor of 4?

% \textit{Answer}: $F^{\prime} = 16 F$

% \framebox{\textbf{Practice}} By what factor does the gravitational force between two objects change when the distance between them \textit{increases} by a factor of 5?

% \textit{Answer}: $F^{\prime} = \frac{1}{25} F$

% \framebox{\textbf{Practice}} By what factor does the gravitational force between two objects change when the distance between them \textit{decreases} by a factor of 5? \textit{Answer}: $F^{\prime} = 25 F$
...
\centering
    \includegraphics[width=3.5cm]{Figure19.2.jpg}
    \label{ZzegPy}
\end{minipage}
}
\vspace{1em}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=5cm,trim={0 0 0 6mm},clip]{Figure19.3.jpg}
    \captionsetup{type=figure,margin=1in,font=scriptsize}
    \captionof{figure}{Electric current moving through a wire.}
    \label{MraOZo}
\end{minipage}
}%
\vspace{1em}
