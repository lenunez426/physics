...
\title{Unit 7: Conservation in Systems}
...
\subsection*{\ref{yUPGRH} Exercises}
\begin{multicols}{2}
...
\subsection*{\ref{HnP5Pm} Exercises}
% \begin{multicols*}{2}
...
\subsection*{\ref{vecM50} Exercises}
...
\subsection*{\ref{v90mza} Exercises}
...
\clearpage
\subsection*{Unit 6 Lesson Plans}
...
\subsection*{\ref{obMgG8} Exercises}
...
\begin{multicols}{2}
\subsection*{\ref{bxZysw} Exercises}
...
\subsection*{\ref{iHOPFl} Exercises}
...
\begin{multicols}{2}
\subsection*{\ref{vRflRn} Exercises}
...
\subsection*{\ref{aOaKHZ} Exercises}

\begin{exercise} \label{jnYiIT}
...
\begin{exercise}
    What 2 quantities does kinetic energy depend on?
\end{exercise}
...
%     \hline\hline
%     \rule{0pt}{2.5ex}
%         $\mathrm{KE_i}$ & initial kinetic energy & joule & J\\
%         $\mathrm{PE_i}$ & initial potential energy & joule & J\\
%         $\mathrm{KE_f}$ & final kinetic energy & joule & J\\
%         $\mathrm{PE_f}$ & final potential energy & joule & J\\
%     \hline
%     \end{tabular}
% \end{center}
...
% \begin{equation} \label{eq:conservation_of_ME} \tag{7.48}
%   \begin{array}{l}
%     \mathrm{ME} = \mathrm{KE} + \mathrm{PE} = \mathrm{constant} \\
%     \vspace{1ex} \\
%     \mathrm{KE_i} + \mathrm{PE_i} = \mathrm{KE_f} + \mathrm{PE_f}
%   \end{array} \Bigg\}\  
%   (\mathrm{conservative\ forces\ only})
% \end{equation}
...
% \textit{PhET Simulation}: ``Energy Skate Park: Intro'' (\href{https://phet.colorado.edu/sims/html/energy-skate-park/latest/energy-skate-park_en.html}{link})
...
\subsection*{\ref{KRxiCV} Exercises}
...
% A 100-kg box falls from \textit{rest} from, the edge of a 50-meter cliff. Calculate the following:

% \vspace{-1em}
% \begin{enumerate}
% \setlength\itemsep{0.1ex}
%     \item $\mathrm{PE_g}$ at the \textbf{top}
%     \item $\mathrm{KE}$ at the \textbf{top}
%     \item $\mathrm{PE_g}$ at the \textbf{bottom}
%     \item $\mathrm{KE}$ at the \textbf{bottom}
%     \item Velocity at the \textbf{bottom}
% \end{enumerate}



% \colorbox{yellow}{\textbf{mechanical energy}} the sum of kinetic and potential energy

% \colorbox{yellow}{\textbf{work-energy theorem}} states the net work done on an object is equal to its change in kinetic energy


% \colorbox{yellow}{\textbf{power}} the rate at which work is done

% \colorbox{yellow}{\textbf{watts (W)}} the metric unit of power; equivalent to joules per second
