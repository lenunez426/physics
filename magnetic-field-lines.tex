...
% Source: https://tikz.net/magnet_fieldlines_dipoles/
...
\colorlet{Bcol}{black}
\colorlet{BcolFL}{black}
\tikzstyle{north}=[thick,top color=black!20,bottom color=black!20,shading angle=20]
%\tikzstyle{south}=[thick,top color=blue!60,bottom color=blue!90,shading angle=20]
\tikzstyle{south}=[thick,top color=white,bottom color=white,shading angle=20]
\contourlength{1.5pt}
\tikzset{
  ...
  pics/magnet/.style={ %args={#1}
    code={
      ...
      %\draw[pic actions,thick,top color=red!60,bottom color=red!90,shading angle=20]
        \draw[pic actions,thick,top color=black!20,bottom color=black!20,shading angle=20]
        (-0.8*\h/2,0) rectangle ++(0.8*\h,\h);
      %\draw[pic actions,thick,top color=blue!60,bottom color=blue!90,shading angle=20]
        \draw[pic actions,thick,top color=white!60,bottom color=white,shading angle=20]
        (-0.8*\h/2,0) rectangle ++(0.8*\h,-\h);
      % \node[pic actions] at (0, \h/2) {\textbf{N}};
      % \node[pic actions] at (0,-\h/2) {\textbf{S}};
      \node[pic actions,rotate=90] at (0, \h/2) {\textbf{N}};
      \node[pic actions,rotate=90] at (0,-\h/2) {\textbf{S}};
  }},
...
\newif\ifShowMagnet
\newif\ifShowMagnetPSTricks
\newif\ifShowEarth


\ShowMagnettrue
\ShowMagnetPSTricksfalse
\ShowEarthfalse
