...
\begin{tikzpicture}
    ...
    \draw[shift={(3,0)}] (0,0) to[battery1] (1,0) node[right] {battery};
...
A \textbf{\gls{simple circuit}} is \glsdesc{simple circuit}.
...
To manipulate Ohm's law alegraically, use the Ohm's law triangle:
