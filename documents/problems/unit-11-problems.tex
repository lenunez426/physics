...
What is the charge of 1 electron? \fillin[][3cm]
...
\subsection*{Electric Current, Voltage, and Resistance}
...
\begin{minipage}{8cm}
\centering
\begin{tikzpicture}[x=5mm,y=3.5mm]
...
\part How does the voltage drop each resistor compare to the voltage drop across the battery? Explain.

\ifprintanswers
\textcolor{red}{Each resistor must have a smaller voltage drop than the potential difference (voltage) across the battery.}
\else
\fillwithlines{7mm}
\fi
\end{parts}
...
\part How does the voltage drop each across resistor compare to the voltage drop across the battery? Explain.

\ifprintanswers
\textcolor{red}{Each resistor must have a smaller voltage drop than the potential difference (voltage) across the battery, so that the same of voltage drops across resistors equals the voltage drop across the battery.}
\else
\fillwithlines{7mm}
\fi
\end{parts}
...
\ifprintanswers
\textcolor{red}{Each resistor has the same voltage drop as the battery. This fact holds true for parallel circuits, even when resistances are different.}
\else
\fillwithlines{7mm}
\fi
\end{parts}
...
\part How does the voltage drop across each resistor compare to the voltage drop across the battery? Explain.
