...
\subsection*{Lab: Acceleration on a Ramp}

\begin{questions}
\question
Observe the motion of the cart starting from rest and rolling down the incline with the motion sensor at the top.
...
\begin{tikzpicture}[x=2.5cm,y=2.5cm]
    \draw (0,0) -- (0,1.2) node[rotate=90,pos=0.5,above] {Position (m)};
    \draw (0,0) -- (1.2,0) node[pos=0.5,below] {Time (s)};
    \ifprintanswers
...
\question
Observe the motion of the cart as you give the cart an initial push up the ramp and stop it at its highest point with the motion sensor at the bottom.
...
\question
Observe the motion of the cart starting from rest and rolling down the incline with the sensor at the bottom.
...
\question
Observe the motion of the cart after you give it an initial push up the ramp and stop it at its highest point, with the sensor at the top.
...
\part
The system in this simulation is the box on the skateboard. Keep the same box on the skateboard at all times. Do not add or remove anything from the skateboard. What is the mass of the box?
