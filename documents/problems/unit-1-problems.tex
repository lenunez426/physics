...
\begin{questions}
\question
Ron Farr runs the following route in 10 seconds: 30 meters in the positive direction, 50 meters in the negative direction, and 15 meters in the positive direction.
...
\begin{tikzpicture}
    \begin{axis}[height=5cm,
        ...
        \ifprintanswers
        \fill[red] (2,20) circle (2pt);
        \fill[red] (8,80) circle (2pt);
        \draw[red] (2,20) -- (8,20) node[above,pos=0.6,fill=white] {$\Delta t = \SI{6}{s}$};
        \draw[red] (8,20) -- (8,80) node[right,pos=0.5,fill=white] {$\Delta x = \SI{60}{m}$};
        \fi
    \end{axis}
\end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    \begin{axis}[width=10cm,
        ...
        \node[above=-3pt] at (3,0) {\resizebox{1cm}{!}{\reflectbox{\usym{1F699}}}};
    \end{axis}
    \end{tikzpicture}
\end{center}
