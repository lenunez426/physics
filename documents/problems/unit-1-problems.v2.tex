...
\subsubsection{Transitioning between Velocity-Time and Position-Time Graphs}
...
\question
The figure below depicts the motion of a cat. Calculate the cat's displacement throughout the time interval. 
...
\question
Find the displacement from the graph.
...
\begin{tikzpicture}
    \begin{axis}[width=8cm,height=4.5cm,
        ...
        \draw[thick] (0,80) -- (2,80) -- (4,20) -- (6,20);
        \ifprintanswers
            \begin{pgfonlayer}{background}
...
\begin{tikzpicture}
    \begin{axis}[width=10cm,height=4.5cm,
        ...
        \draw[thick] (0,20) -- (10,10) -- (30,10) -- (60,20);
        \ifprintanswers
            \begin{pgfonlayer}{background}
...
\begin{tikzpicture}
    \begin{axis}[width=10cm,height=4.5cm,
        ...
        \draw[thick] (0,2) -- (10,6) -- (15,2) -- (25,2) -- (30,10);
        \ifprintanswers
            \begin{pgfonlayer}{background}
...
\begin{tikzpicture}
    \begin{axis}[width=10cm,height=4.5cm,
        ...
        \draw[thick] (0,15) -- (4,5) -- (8,20) -- (12,20) -- (16,10) -- (20,5);
        \ifprintanswers
            \begin{pgfonlayer}{background}
