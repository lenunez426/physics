...
\ifversionKlevel
\header{{Name:\enspace\makebox[6cm]{\hrulefill}}}{}{Physics Test on Unit 4: Impulse and Work}
    ...
    \begin{tikzpicture}
        \begin{axis}[width=6cm,height=4cm,
            ...
            \begin{pgfonlayer}{background}
                \fill[red!12] (0,0) rectangle (10,3);
            \end{pgfonlayer}
            \fi
        \end{axis}
    \end{tikzpicture}
...
\question[6]
The \SI{1000}{kg} car below is moving at \SI{30}{m/s}. A net force brings the car to rest in 5 seconds.
...
\part 
Calculate the initial momentum of the car. Then calculate the car's change in momentum.

\begin{solutionorbox}[2.5cm]
\begin{equation*}
    p_i = m v_i = (\SI{1000}{kg})(\SI{30}{m/s}) = \boxed{\SI{30000}{kg\cdot m/s}}
\end{equation*}

\begin{equation*}
    \Delta p = p_f - p_i = 0 - \SI{30000}{kg\cdot m/s} = \boxed{\SI{-30000}{kg\cdot m/s}}
\end{equation*}
\end{solutionorbox}

\part Write an equation relating the force on the car, the time during which the force acts, and the change in the car's momentum. (\textit{Hint:} What's the impulse-momentum theorem?)
...
\part Find the magnitude of the force on the car during the time interval.

\begin{solutionorbox}[5.5cm]
Above, we found $\Delta p = \SI{-30000}{kg\cdot m/s}$. By the impulse-momentum theorem,

\begin{equation*}
    F_\mathrm{net} \Delta t = \Delta p 
\end{equation*}

Dividing both sides by the time interval leads to 

\begin{align*}
    F_\mathrm{net} &= \frac{\Delta p}{\Delta t} \\[1ex]
    &= \frac{\SI{-30000}{kg\cdot m/s}}{\SI{5}{s}} \\[1ex]
    &= \SI{-6000}{N}
\end{align*}

Therefore, the magnitude of the force is $\boxed{\SI{6000}{N}}$
\end{solutionorbox}
\end{parts}
...
\textbf{\color{red} 2 points}: For explaining (in words and/or equations) that the force on the egg at impact is governed by the impulse-momentum theorem: $F_\mathrm{ave} \Delta t = \Delta p$.

 \textbf{\color{red} 2 points}: For explaining that the pillow increases the time interval during which the pillow's force on the egg occurs, thus decreasing the magnitude of this force.
...
\part Calculate the player's initial kinetic energy. Then find the change in his kinetic energy across the entire time interval.

\begin{solutionorbox}[2.5cm]
\begin{equation*}
    K_i = \frac{1}{2}m v_i^2 = \frac{1}{2}(\SI{50}{kg}) \left(\SI{5}{m/s}\right)^2 = \boxed{\SI{625}{J}}
\end{equation*}
...
\part What is the work done on the player by the frictional force?

\begin{solutionorbox}[1.5cm]
By the work-energy theorem,

\begin{equation*}
    W = \Delta K = \boxed{\SI{-625}{J}}
\end{equation*}
\end{solutionorbox}

\part Calculate the magnitude of the average power dissipated by friction.

\begin{solutionorbox}[3cm]
Above, we found $W = \SI{-625}{J}$. According to the graph, the time interval during which work was done is $\Delta t = \SI{2.5}{s}$. Therefore, power is
...
Therefore, the magnitude of the power dissipated is $\boxed{\SI{250}{W}}$.
\end{solutionorbox}
\end{parts}
...
\begin{mdframed}[backgroundcolor=black!10]
    \centering
    \textbf{\small TEACHER USE ONLY}\\[1em]
    \partialgradetable{myrangeII}[h][questions]
\end{mdframed}
\clearpage
\fi
...
\textbf{\color{red} 2 points}: For stating that impulse is the product of force and time.

\textbf{\color{red} 2 points}: For stating that work is the product of force and displacement.
\end{solution}
\endgradingrange{myrangeII} 
