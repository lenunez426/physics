...
\firstpageheader{Physics L}{Unit 2: Force Interactions}{Make-Up Test}
\runningheader{}{}{}

\ifversionKlevel
    \firstpageheader{Physics K}{Unit 2: Force Interactions}{Make-Up Test}
    \runningheader{}{}{}
\fi
...
\clearpage
\question
%...To Do: remove grid lines; use capital letters for points
...
\begin{center}
    \begin{tikzpicture}
        \draw (0,0) node {\reflectbox{\twemoji[height=2cm]{delivery truck}}};
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[thick,<-,right=1.5cm] (0,0) -- (0.7,0) node[above,pos=0.5] {5\,N};
        \draw[thick,<-,left=1.5cm] (0,0) -- (-0.7,0) node[above,pos=0.5] {5\,N};
        \draw[thick,<-,above=1.2cm] (0,0) -- (0,1.5) node[right,pos=0.5] {20\,N};
        \draw[thick,<-,below=1.2cm] (0,0) -- (0,-1.5) node[right,pos=0.5] {20\,N};
    \end{tikzpicture}
\end{center}
